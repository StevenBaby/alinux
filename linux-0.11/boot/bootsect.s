...
_start: 
	...
	! 移动到0x9000(576k)处，共 256 字（512 字节）
...
go:	
	...
	mov	ss,ax
	mov	sp,#0xFF00		! 任意远远大于 0x200 的数，确保程序执行过程中，栈不会溢出
...
ok_load_setup:
	...
	! 因为 7*4 + 0 = 28，所以 /dev/PS0 (2,28) 指的是 1.44 M A 驱动器 其设备号是0x021c
